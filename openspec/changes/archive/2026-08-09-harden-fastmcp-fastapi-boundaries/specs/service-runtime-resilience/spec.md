...
El sistema MUST correlacionar cada petición con un request ID y MUST observar únicamente método, plantilla de ruta, status y latencia mediante campos de baja cardinalidad.

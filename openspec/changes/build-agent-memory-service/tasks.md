...
- [ ] 6.5 Configurar backups diarios de PostgreSQL y documentar una restauración verificada. *(mecanismo elegido: **backups nativos de Dokploy a S3** — documentado en `docs/operations.md`; los scripts propios quedan como alternativa self-hosted. Pendiente (requiere el deploy de la DB en Dokploy + un bucket S3): configurar destino S3 + schedule diario y ejecutar un simulacro de restore verificado)*

#!/usr/bin/env python3
"""Muse Code SessionStart entrypoint for the Recallum hook.
...
SessionStart source; it marks the Muse client and delegates to the shared
implementation. Must stay compatible with Python 3.9.
"""
